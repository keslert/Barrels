package  {
	public class StageSelect {
		public static function getCannons():Array {
			...
			[625,950,625,950,3,false,false,0,0,0,-2,false,0,20,2,5],
			[625,500,625,500,3,false,false,0,0,0,90,true,20,30,1,0],
			[250,525,250,525,3,false,false,0,70,0,-90,false,30,15,2,6],
		...
		public static function getEnemys():Array {
			var enemys=[
				[550,925,550,925,false,false,3,25,1],
				[550,975,550,975,false,false,3,25,1],
				[750,500,750,500,false,false,3,30,1],
				[625,400,625,400,false,false,3,25,1],
				[1125,500,1125,500,false,false,3,25,1]
			];
			return enemys;
		}
