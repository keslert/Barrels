package  {
	...
	public class Level {
		...
		public static function getItems(level:int):Array {
			...
			if(level==10) {
				items=[ 
				[925,100,925,100,false,0,20,1],
				[1000,75,1000,75,false,0,20,1],
				[1075,100,1075,100,false,0,20,1],
				[200,700,200,700,false,0,20,1],
				[1575,225,1575,225,false,0,20,2],
				[1450,900,1450,900,false,0,20,1],
				[375,150,375,150,false,0,20,1],
				[200,525,200,525,false,0,20,1],
				[200,400,200,400,false,0,20,1]
				];
				return items;
			}
			items=[]
